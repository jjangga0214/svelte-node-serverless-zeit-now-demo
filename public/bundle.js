    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a1, file, 21, 4, 397);
    			attr_dev(a2, "href", "https://svelte.dev/");
    			add_location(a2, file, 28, 4, 565);
    			add_location(code0, file, 30, 4, 642);
    			add_location(code1, file, 32, 4, 690);
    			add_location(code2, file, 34, 4, 748);
    			attr_dev(a3, "href", "https://nodejs.org/en/");
    			add_location(a3, file, 36, 4, 802);
    			add_location(code3, file, 39, 6, 896);
    			attr_dev(a4, "href", "/api/date");
    			add_location(a4, file, 38, 4, 869);
    			add_location(p0, file, 20, 2, 389);
    			add_location(br, file, 44, 2, 978);
    			add_location(h21, file, 45, 2, 987);
    			add_location(p1, file, 46, 2, 1032);
